...
SELECT
    ...
    -- {{ target.schema }}.tratarCampoBoolString(fat_aves.is_comportamento_nomadico) AS tp_comportamento_nomadico,
    -- {{ target.schema }}.tratarCampoBoolString(fat_aves.is_comportamento_sedentario) AS tp_comportamento_sedentario,
    -- {{ target.schema }}.tratarCampoBoolString(fat_aves.is_comportamento_territorial) AS tp_comportamento_territorial,
    -- {{ target.schema }}.tratarCampoBoolString(fat_aves.is_comportamento_parasitismo_nidal) AS tp_comportamento_parasitismo_nidal
FROM
